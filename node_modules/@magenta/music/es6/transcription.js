 ...
 * @license  MIT
 */
e.exports=function(e){return null!=e&&(n(e)||function(e){return"function"==typeof e.readFloatLE&&"function"==typeof e.slice&&n(e.slice(0,0))}(e)||!!e._isBuffer)}},function(e,t,n){"use strict";var r=n(34),o=n(15),i=n(41),a=n(56);e.exports=function(e,t,n){var s,u,c=t.shape,l=c.length,f=1,p=new Array(l),h=0;for(s=l-1;s>=0;--s)if(p[s]=f,f*=c[s],h=Math.max(h,a.scratchMemory(c[s])),t.shape[s]!==n.shape[s])throw new Error("Shape mismatch, real and imaginary arrays must have same size");var d,m=4*f+h;d="array"===t.dtype||"float64"===t.dtype||"custom"===t.dtype?i.mallocDouble(m):i.mallocFloat(m);var g,y,b,w,S=o(d,c.slice(0),p,0),v=o(d,c.slice(0),p.slice(0),f),A=o(d,c.slice(0),p.slice(0),2*f),_=o(d,c.slice(0),p.slice(0),3*f),N=4*f;for(r.assign(S,t),r.assign(v,n),s=l-1;s>=0&&(a(e,f/c[s],c[s],d,S.offset,v.offset,N),0!==s);--s){for(y=1,b=A.stride,w=_.stride,u=s-1;u<l;++u)w[u]=b[u]=y,y*=c[u];for(u=s-2;u>=0;--u)w[u]=b[u]=y,y*=c[u];r.assign(A,S),r.assign(_,v),g=S,S=A,A=g,g=v,v=_,_=g}r.assign(t,S),r.assign(n,v),i.free(d)}},function(e,t,n){"use strict";var r=n(54);e.exports=function(e){var t=["'use strict'","var CACHED={}"],n=[],o=e.funcName+"_cwise_thunk";t.push(["return function ",o,"(",e.shimArgs.join(","),"){"].join(""));for(var i=[],a=[],s=[["array",e.arrayArgs[0],".shape.slice(",Math.max(0,e.arrayBlockIndices[0]),e.arrayBlockIndices[0]<0?","+e.arrayBlockIndices[0]+")":")"].join("")],u=[],c=[],l=0;l<e.arrayArgs.length;++l){var f=e.arrayArgs[l];n.push(["t",f,"=array",f,".dtype,","r",f,"=array",f,".order"].join("")),i.push("t"+f),i.push("r"+f),a.push("t"+f),a.push("r"+f+".join()"),s.push("array"+f+".data"),s.push("array"+f+".stride"),s.push("array"+f+".offset|0"),l>0&&(u.push("array"+e.arrayArgs[0]+".shape.length===array"+f+".shape.length+"+(Math.abs(e.arrayBlockIndices[0])-Math.abs(e.arrayBlockIndices[l]))),c.push("array"+e.arrayArgs[0]+".shape[shapeIndex+"+Math.max(0,e.arrayBlockIndices[0])+"]===array"+f+".shape[shapeIndex+"+Math.max(0,e.arrayBlockIndices[l])+"]"))}for(e.arrayArgs.length>1&&(t.push("if (!("+u.join(" && ")+")) throw new Error('cwise: Arrays do not all have the same dimensionality!')"),t.push("for(var shapeIndex=array"+e.arrayArgs[0]+".shape.length-"+Math.abs(e.arrayBlockIndices[0])+"; shapeIndex--\x3e0;) {"),t.push("if (!("+c.join(" && ")+")) throw new Error('cwise: Arrays do not all have the same shape!')"),t.push("}")),l=0;l<e.scalarArgs.length;++l)s.push("scalar"+e.scalarArgs[l]);return n.push(["type=[",a.join(","),"].join()"].join("")),n.push("proc=CACHED[type]"),t.push("var "+n.join(",")),t.push(["if(!proc){","CACHED[type]=proc=compile([",i.join(","),"])}","return proc(",s.join(","),")}"].join("")),e.debug&&console.log("-----Generated thunk:\n"+t.join("\n")+"\n----------"),new Function("compile",t.join("\n"))(r.bind(void 0,e))}},function(e,t,n){"use strict";var r=n(40);function o(e,t,n){var r,o,i=e.length,a=t.arrayArgs.length,s=t.indexArgs.length>0,u=[],c=[],l=0,f=0;for(r=0;r<i;++r)c.push(["i",r,"=0"].join(""));for(o=0;o<a;++o)for(r=0;r<i;++r)f=l,l=e[r],0===r?c.push(["d",o,"s",r,"=t",o,"p",l].join("")):c.push(["d",o,"s",r,"=(t",o,"p",l,"-s",f,"*t",o,"p",f,")"].join(""));for(c.length>0&&u.push("var "+c.join(",")),r=i-1;r>=0;--r)l=e[r],u.push(["for(i",r,"=0;i",r,"<s",l,";++i",r,"){"].join(""));for(u.push(n),r=0;r<i;++r){for(f=l,l=e[r],o=0;o<a;++o)u.push(["p",o,"+=d",o,"s",r].join(""));s&&(r>0&&u.push(["index[",f,"]-=s",f].join("")),u.push(["++index[",l,"]"].join(""))),u.push("}")}return u.join("\n")}function i(e,t,n){for(var r=e.body,o=[],i=[],a=0;a<e.args.length;++a){var s=e.args[a];if(!(s.count<=0)){var u=new RegExp(s.name,"g"),c="",l=t.arrayArgs.indexOf(a);switch(t.argTypes[a]){case"offset":var f=t.offsetArgIndex.indexOf(a);l=t.offsetArgs[f].array,c="+q"+f;case"array":c="p"+l+c;var p="l"+a,h="a"+l;if(0===t.arrayBlockIndices[l])1===s.count?"generic"===n[l]?s.lvalue?(o.push(["var ",p,"=",h,".get(",c,")"].join("")),r=r.replace(u,p),i.push([h,".set(",c,",",p,")"].join(""))):r=r.replace(u,[h,".get(",c,")"].join("")):r=r.replace(u,[h,"[",c,"]"].join("")):"generic"===n[l]?(o.push(["var ",p,"=",h,".get(",c,")"].join("")),r=r.replace(u,p),s.lvalue&&i.push([h,".set(",c,",",p,")"].join(""))):(o.push(["var ",p,"=",h,"[",c,"]"].join("")),r=r.replace(u,p),s.lvalue&&i.push([h,"[",c,"]=",p].join("")));else{for(var d=[s.name],m=[c],g=0;g<Math.abs(t.arrayBlockIndices[l]);g++)d.push("\\s*\\[([^\\]]+)\\]"),m.push("$"+(g+1)+"*t"+l+"b"+g);if(u=new RegExp(d.join(""),"g"),c=m.join("+"),"generic"===n[l])throw new Error("cwise: Generic arrays not supported in combination with blocks!");r=r.replace(u,[h,"[",c,"]"].join(""))}break;case"scalar":r=r.replace(u,"Y"+t.scalarArgs.indexOf(a));break;case"index":r=r.replace(u,"index");break;case"shape":r=r.replace(u,"shape")}}}return[o.join("\n"),r,i.join("\n")].join("\n").trim()}function a(e){for(var t=new Array(e.length),n=!0,r=0;r<e.length;++r){var o=e[r],i=o.match(/\d+/);i=i?i[0]:"",0===o.charAt(0)?t[r]="u"+o.charAt(1)+i:t[r]=o.charAt(0)+i,r>0&&(n=n&&t[r]===t[r-1])}return n?t[0]:t.join("")}e.exports=function(e,t){for(var n=t[1].length-Math.abs(e.arrayBlockIndices[0])|0,s=new Array(e.arrayArgs.length),u=new Array(e.arrayArgs.length),c=0;c<e.arrayArgs.length;++c)u[c]=t[2*c],s[c]=t[2*c+1];var l=[],f=[],p=[],h=[],d=[];for(c=0;c<e.arrayArgs.length;++c){e.arrayBlockIndices[c]<0?(p.push(0),h.push(n),l.push(n),f.push(n+e.arrayBlockIndices[c])):(p.push(e.arrayBlockIndices[c]),h.push(e.arrayBlockIndices[c]+n),l.push(0),f.push(e.arrayBlockIndices[c]));for(var m=[],g=0;g<s[c].length;g++)p[c]<=s[c][g]&&s[c][g]<h[c]&&m.push(s[c][g]-p[c]);d.push(m)}var y=["SS"],b=["'use strict'"],w=[];for(g=0;g<n;++g)w.push(["s",g,"=SS[",g,"]"].join(""));for(c=0;c<e.arrayArgs.length;++c){y.push("a"+c),y.push("t"+c),y.push("p"+c);for(g=0;g<n;++g)w.push(["t",c,"p",g,"=t",c,"[",p[c]+g,"]"].join(""));for(g=0;g<Math.abs(e.arrayBlockIndices[c]);++g)w.push(["t",c,"b",g,"=t",c,"[",l[c]+g,"]"].join(""))}for(c=0;c<e.scalarArgs.length;++c)y.push("Y"+c);if(e.shapeArgs.length>0&&w.push("shape=SS.slice(0)"),e.indexArgs.length>0){var S=new Array(n);for(c=0;c<n;++c)S[c]="0";w.push(["index=[",S.join(","),"]"].join(""))}for(c=0;c<e.offsetArgs.length;++c){var v=e.offsetArgs[c],A=[];for(g=0;g<v.offset.length;++g)0!==v.offset[g]&&(1===v.offset[g]?A.push(["t",v.array,"p",g].join("")):A.push([v.offset[g],"*t",v.array,"p",g].join("")));0===A.length?w.push("q"+c+"=0"):w.push(["q",c,"=",A.join("+")].join(""))}var _=r([].concat(e.pre.thisVars).concat(e.body.thisVars).concat(e.post.thisVars));for((w=w.concat(_)).length>0&&b.push("var "+w.join(",")),c=0;c<e.arrayArgs.length;++c)b.push("p"+c+"|=0");e.pre.body.length>3&&b.push(i(e.pre,e,u));var N=i(e.body,e,u),O=function(e){for(var t=0,n=e[0].length;t<n;){for(var r=1;r<e.length;++r)if(e[r][t]!==e[0][t])return t;++t}return t}(d);O<n?b.push(function(e,t,n,r){for(var i=t.length,a=n.arrayArgs.length,s=n.blockSize,u=n.indexArgs.length>0,c=[],l=0;l<a;++l)c.push(["var offset",l,"=p",l].join(""));for(l=e;l<i;++l)c.push(["for(var j"+l+"=SS[",t[l],"]|0;j",l,">0;){"].join("")),c.push(["if(j",l,"<",s,"){"].join("")),c.push(["s",t[l],"=j",l].join("")),c.push(["j",l,"=0"].join("")),c.push(["}else{s",t[l],"=",s].join("")),c.push(["j",l,"-=",s,"}"].join("")),u&&c.push(["index[",t[l],"]=j",l].join(""));for(l=0;l<a;++l){for(var f=["offset"+l],p=e;p<i;++p)f.push(["j",p,"*t",l,"p",t[p]].join(""));c.push(["p",l,"=(",f.join("+"),")"].join(""))}for(c.push(o(t,n,r)),l=e;l<i;++l)c.push("}");return c.join("\n")}(O,d[0],e,N)):b.push(o(d[0],e,N)),e.post.body.length>3&&b.push(i(e.post,e,u)),e.debug&&console.log("-----Generated cwise routine for ",t,":\n"+b.join("\n")+"\n----------");var k=[e.funcName||"unnamed","_cwise_loop_",s[0].join("s"),"m",O,a(u)].join("");return new Function(["function ",k,"(",y.join(","),"){",b.join("\n"),"} return ",k].join(""))()}},function(e,t,n){"use strict";e.exports=function(e,t){switch(void 0===t&&(t=0),typeof e){case"number":if(e>0)return function(e,t){var n,r;for(n=new Array(e),r=0;r<e;++r)n[r]=t;return n}(0|e,t);break;case"object":if("number"==typeof e.length)return function e(t,n,r){var o=0|t[r];if(o<=0)return[];var i,a=new Array(o);if(r===t.length-1)for(i=0;i<o;++i)a[i]=n;else for(i=0;i<o;++i)a[i]=e(t,n,r+1);return a}(e,t,0)}return[]}},function(e,t,n){var r=n(42);function o(e,t,n,o,i,a){var s,u,c,l,f,p,h,d,m,g,y,b,w,S,v,A,_,N,O,k,I,x,P,E;for(e|=0,t|=0,i|=0,a|=0,s=n|=0,u=r.log2(s),N=0;N<t;++N){for(h=s>>1,f=0,c=0;c<s-1;c++){for(c<f&&(w=o[i+c],o[i+c]=o[i+f],o[i+f]=w,w=o[a+c],o[a+c]=o[a+f],o[a+f]=w),p=h;p<=f;)f-=p,p>>=1;f+=p}for(y=-1,b=0,g=1,d=0;d<u;d++){for(m=g,g<<=1,A=1,_=0,f=0;f<m;f++){for(c=f;c<s;c+=g)O=o[i+(l=c+m)],k=o[a+l],I=o[i+c],x=o[a+c],S=(P=A*(O+k))-k*(A+_),v=P+(E=O*(_-A)),o[i+l]=I-S,o[a+l]=x-v,o[i+c]+=S,o[a+c]+=v;E=A*(b-y),A=(P=y*(A+_))-_*(y+b),_=P+E}b=Math.sqrt((1-y)/2),e<0&&(b=-b),y=Math.sqrt((1+y)/2)}if(e<0){var T=1/s;for(c=0;c<s;c++)o[i+c]*=T,o[a+c]*=T}i+=n,a+=n}}e.exports=function(e,t,n,i,a,s,u){e|=0,t|=0,n|=0,a|=0,s|=0,r.isPow2(n)?o(e,t,n,i,a,s):function(e,t,n,i,a,s,u){e|=0,t|=0,n|=0,a|=0,s|=0,u|=0;var c,l,f,p,h,d,m,g,y,b=r.nextPow2(2*n+1),w=u,S=w+n,v=S+n,A=v+b,_=A+b,N=_+b,O=-e*Math.PI/n;for(y=0;y<n;++y)l=O*(y*y%(2*n)),p=Math.cos(l),h=Math.sin(l),i[_+(b-y)]=i[_+y]=i[w+y]=p,i[N+(b-y)]=i[N+y]=i[S+y]=h;for(y=n;y<=b-n;++y)i[_+y]=0;for(y=n;y<=b-n;++y)i[N+y]=0;o(1,1,b,i,_,N),O=e<0?1/n:1;for(c=0;c<t;++c){for(y=0;y<n;++y)l=i[a+y],f=i[s+y],p=i[w+y],h=-i[S+y],d=p*(l+f),m=l*(h-p),g=f*(p+h),i[v+y]=d-g,i[A+y]=d+m;for(y=n;y<b;++y)i[v+y]=0;for(y=n;y<b;++y)i[A+y]=0;for(o(1,1,b,i,v,A),y=0;y<b;++y)l=i[v+y],f=i[A+y],p=i[_+y],h=i[N+y],d=p*(l+f),m=l*(h-p),g=f*(p+h),i[v+y]=d-g,i[A+y]=d+m;for(o(-1,1,b,i,v,A),y=0;y<n;++y)l=i[v+y],f=i[A+y],p=i[w+y],h=-i[S+y],d=p*(l+f),m=l*(h-p),g=f*(p+h),i[a+y]=O*(d-g),i[s+y]=O*(d+m);a+=n,s+=n}}(e,t,n,i,a,s,u)},e.exports.scratchMemory=function(e){return r.isPow2(e)?0:2*e+4*r.nextPow2(2*e+1)}},function(e,t,n){"use strict";var r=n(15),o=n(34),i=n(41);t.clone=function(e){var t=e.dtype;"generic"!==t&&"array"!==t||(t="double");var n=i.malloc(e.size,t),a=r(n,e.shape);return o.assign(a,e),a},t.malloc=function(e,t){t||(t="double");for(var n=1,o=new Array(e.length),a=e.length-1;a>=0;--a)o[a]=n,n*=e[a];return r(i.malloc(n,t),e,o,0)},t.free=function(e){"generic"!==e.dtype&&"array"!==e.dtype&&i.free(e.data)},t.zeros=function(e,t){t||(t="double");for(var n=1,o=new Array(e.length),a=e.length-1;a>=0;--a)o[a]=n,n*=e[a];var s=i.malloc(n,t);for(a=0;a<n;++a)s[a]=0;return r(s,e,o,0)},t.ones=function(e,t){t||(t="double");for(var n=1,o=new Array(e.length),a=e.length-1;a>=0;--a)o[a]=n,n*=e[a];var s=i.malloc(n,t);for(a=0;a<n;++a)s[a]=1;return r(s,e,o,0)},t.eye=function(e,t){var n,o;t||(t="double");var a=1,s=new Array(e.length);for(n=e.length-1;n>=0;--n)s[n]=a,a*=e[n];var u=i.malloc(a,t);for(n=0;n<a;++n)u[n]=0;var c=1/0,l=0;for(n=e.length-1;n>=0;n--)l+=s[n],c=Math.min(c,e[n]);for(n=0,o=0;n<c;n++,o+=l)u[o]=1;return r(u,e,s,0)}},function(e,t,n){"use strict";var r=n(59),o=n(39),i=["args","body"],a=["pre","post","printCode","funcName","blockSize"];e.exports=function(e){for(var t in e)i.indexOf(t)<0&&a.indexOf(t)<0&&console.warn("cwise: Unknown argument '"+t+"' passed to expression compiler");for(var n=0;n<i.length;++n)if(!e[i[n]])throw new Error("cwise: Missing argument: "+i[n]);return o({args:e.args,pre:r(e.pre||function(){}),body:r(e.body),post:r(e.post||function(){}),debug:!!e.printCode,funcName:e.funcName||e.body.name||"cwise",blockSize:e.blockSize||64})}},function(e,t,n){"use strict";(function(t){var r=n(60),o=n(40),i=0;function a(e,t,n){this.name=e,this.lvalue=t,this.rvalue=n,this.count=0}function s(e,t,n,r){this.body=e,this.args=t,this.thisVars=n,this.localVars=r}e.exports=function(e){for(var n=["(",e,")()"].join(""),u=r.parse(n,{range:!0}),c="_inline_"+i+++"_",l=function(e){for(var t=e.body[0].expression.callee.params,n=new Array(t.length),r=0;r<t.length;++r)n[r]=t[r].name;return n}(u),f=new Array(l.length),p=0;p<l.length;++p)f[p]=new a([c,"arg",p,"_"].join(""),!1,!1);for(var h=new Array(n.length),d=(p=0,n.length);p<d;++p)h[p]=n.charAt(p);var m,g=[],y=[];function b(e,t){for(var n=e.range[0],r=e.range[1],o=n+1;o<r;++o)h[o]="";h[n]=t}return function e(n,r){if(n.parent=r,"MemberExpression"===n.type)n.computed?(e(n.object,n),e(n.property,n)):"ThisExpression"===n.object.type?b(n,(w=n.property.name,S="this_"+w.replace(/\_/g,"__"),y.push(S),S)):e(n.object,n);else{if("ThisExpression"===n.type)throw new Error("cwise-parser: Computed this is not allowed");if("Identifier"===n.type){var o=n.name,i=l.indexOf(o);if(i>=0){var a=f[i],s=function(e){return"AssignmentExpression"===e.parent.type&&e.parent.left===e?"="===e.parent.operator?1:3:"UpdateExpression"===e.parent.type?3:2}(n);1&s&&(a.lvalue=!0),2&s&&(a.rvalue=!0),++a.count,b(n,a.name)}else(function(e){if("eval"===e)throw new Error("cwise-parser: eval() not allowed");return"undefined"!=typeof window?e in window:void 0!==t?e in t:"undefined"!=typeof self&&e in self})(o)||b(n,function(e){var t=c+e.replace(/\_/g,"__");return g.push(t),t}(o))}else if("Literal"===n.type)"string"==typeof n.value&&b(n,"'"+n.value.replace(/\_/g,"\\_").replace(/\'/g,"'")+"'");else{if("WithStatement"===n.type)throw new Error("cwise-parser: with() statements not allowed");for(var u=Object.keys(n),p=0,h=u.length;p<h;++p)if("parent"!==u[p]){var d=n[u[p]];if(d)if(d instanceof Array)for(var m=0;m<d.length;++m)d[m]&&"string"==typeof d[m].type&&e(d[m],n);else"string"==typeof d.type&&e(d,n)}}}var w,S}(u.body[0].expression.callee.body,void 0),o(g),o(y),new s((m=u.body[0].expression.callee.body,h.slice(m.range[0],m.range[1]).join("")),f,y,g)}}).call(this,n(8))},function(e,t,n){var r,o,i;!function(n,a){"use strict";o=[t],void 0===(i="function"==typeof(r=function(e){var t,n,r,o,i,a,s,u,c,l,f,p,h,d,m,g,y,b;function w(e,t){if(!e)throw new Error("ASSERT: "+t)}function S(e){return e>=48&&e<=57}function v(e){return"0123456789abcdefABCDEF".indexOf(e)>=0}function A(e){return"01234567".indexOf(e)>=0}function _(e){return 32===e||9===e||11===e||12===e||160===e||e>=5760&&[5760,6158,8192,8193,8194,8195,8196,8197,8198,8199,8200,8201,8202,8239,8287,12288,65279].indexOf(e)>=0}function N(e){return 10===e||13===e||8232===e||8233===e}function O(e){return 36===e||95===e||e>=65&&e<=90||e>=97&&e<=122||92===e||e>=128&&s.NonAsciiIdentifierStart.test(String.fromCharCode(e))}function k(e){return 36===e||95===e||e>=65&&e<=90||e>=97&&e<=122||e>=48&&e<=57||92===e||e>=128&&s.NonAsciiIdentifierPart.test(String.fromCharCode(e))}function I(e){switch(e){case"implements":case"interface":case"package":case"private":case"protected":case"public":case"static":case"yield":case"let":return!0;default:return!1}}function x(e){return"eval"===e||"arguments"===e}function P(e,t,n,r,o){var i;w("number"==typeof n,"Comment must have valid position"),y.lastCommentStart>=n||(y.lastCommentStart=n,i={type:e,value:t},b.range&&(i.range=[n,r]),b.loc&&(i.loc=o),b.comments.push(i),b.attachComment&&(b.leadingComments.push(i),b.trailingComments.push(i)))}function E(e){var t,n,r,o;for(t=f-e,n={start:{line:p,column:f-h-e}};f<d;)if(r=c.charCodeAt(f),++f,N(r))return b.comments&&(o=c.slice(t+e,f-1),n.end={line:p,column:f-h-1},P("Line",o,t,f-1,n)),13===r&&10===c.charCodeAt(f)&&++f,++p,void(h=f);b.comments&&(o=c.slice(t+e,f),n.end={line:p,column:f-h},P("Line",o,t,f,n))}function T(){var e,t,n,r;for(b.comments&&(e=f-2,t={start:{line:p,column:f-h-2}});f<d;)if(N(n=c.charCodeAt(f)))13===n&&10===c.charCodeAt(f+1)&&++f,++p,++f,h=f,f>=d&&Y({},a.UnexpectedToken,"ILLEGAL");else if(42===n){if(47===c.charCodeAt(f+1))return++f,++f,void(b.comments&&(r=c.slice(e+2,f-2),t.end={line:p,column:f-h},P("Block",r,e,f,t)));++f}else++f;Y({},a.UnexpectedToken,"ILLEGAL")}function q(){var e,t;for(t=0===f;f<d;)if(_(e=c.charCodeAt(f)))++f;else if(N(e))++f,13===e&&10===c.charCodeAt(f)&&++f,++p,h=f,t=!0;else if(47===e)if(47===(e=c.charCodeAt(f+1)))++f,++f,E(2),t=!0;else{if(42!==e)break;++f,++f,T()}else if(t&&45===e){if(45!==c.charCodeAt(f+1)||62!==c.charCodeAt(f+2))break;f+=3,E(3)}else{if(60!==e)break;if("!--"!==c.slice(f+1,f+4))break;++f,++f,++f,++f,E(4)}}function j(e){var t,n,r,o=0;for(n="u"===e?4:2,t=0;t<n;++t){if(!(f<d&&v(c[f])))return"";r=c[f++],o=16*o+"0123456789abcdef".indexOf(r.toLowerCase())}return String.fromCharCode(o)}function L(){var e,t;for(e=c.charCodeAt(f++),t=String.fromCharCode(e),92===e&&(117!==c.charCodeAt(f)&&Y({},a.UnexpectedToken,"ILLEGAL"),++f,(e=j("u"))&&"\\"!==e&&O(e.charCodeAt(0))||Y({},a.UnexpectedToken,"ILLEGAL"),t=e);f<d&&k(e=c.charCodeAt(f));)++f,t+=String.fromCharCode(e),92===e&&(t=t.substr(0,t.length-1),117!==c.charCodeAt(f)&&Y({},a.UnexpectedToken,"ILLEGAL"),++f,(e=j("u"))&&"\\"!==e&&k(e.charCodeAt(0))||Y({},a.UnexpectedToken,"ILLEGAL"),t+=e);return t}function C(){var e,n;return e=f,{type:1===(n=92===c.charCodeAt(f)?L():function(){var e,t;for(e=f++;f<d;){if(92===(t=c.charCodeAt(f)))return f=e,L();if(!k(t))break;++f}return c.slice(e,f)}()).length?t.Identifier:function(e){if(l&&I(e))return!0;switch(e.length){case 2:return"if"===e||"in"===e||"do"===e;case 3:return"var"===e||"for"===e||"new"===e||"try"===e||"let"===e;case 4:return"this"===e||"else"===e||"case"===e||"void"===e||"with"===e||"enum"===e;case 5:return"while"===e||"break"===e||"catch"===e||"throw"===e||"const"===e||"yield"===e||"class"===e||"super"===e;case 6:return"return"===e||"typeof"===e||"delete"===e||"switch"===e||"export"===e||"import"===e;case 7:return"default"===e||"finally"===e||"extends"===e;case 8:return"function"===e||"continue"===e||"debugger"===e;case 10:return"instanceof"===e;default:return!1}}(n)?t.Keyword:"null"===n?t.NullLiteral:"true"===n||"false"===n?t.BooleanLiteral:t.Identifier,value:n,lineNumber:p,lineStart:h,start:e,end:f}}function B(){var e,n,r,o,i=f,s=c.charCodeAt(f),u=c[f];switch(s){case 46:case 40:case 41:case 59:case 44:case 123:case 125:case 91:case 93:case 58:case 63:case 126:return++f,b.tokenize&&(40===s?b.openParenToken=b.tokens.length:123===s&&(b.openCurlyToken=b.tokens.length)),{type:t.Punctuator,value:String.fromCharCode(s),lineNumber:p,lineStart:h,start:i,end:f};default:if(61===(e=c.charCodeAt(f+1)))switch(s){case 43:case 45:case 47:case 60:case 62:case 94:case 124:case 37:case 38:case 42:return f+=2,{type:t.Punctuator,value:String.fromCharCode(s)+String.fromCharCode(e),lineNumber:p,lineStart:h,start:i,end:f};case 33:case 61:return f+=2,61===c.charCodeAt(f)&&++f,{type:t.Punctuator,value:c.slice(i,f),lineNumber:p,lineStart:h,start:i,end:f}}}return">>>="===(o=c.substr(f,4))?{type:t.Punctuator,value:o,lineNumber:p,lineStart:h,start:i,end:f+=4}:">>>"===(r=o.substr(0,3))||"<<="===r||">>="===r?{type:t.Punctuator,value:r,lineNumber:p,lineStart:h,start:i,end:f+=3}:u===(n=r.substr(0,2))[1]&&"+-<>&|".indexOf(u)>=0||"=>"===n?{type:t.Punctuator,value:n,lineNumber:p,lineStart:h,start:i,end:f+=2}:"<>=!+-*%&|^/".indexOf(u)>=0?(++f,{type:t.Punctuator,value:u,lineNumber:p,lineStart:h,start:i,end:f}):void Y({},a.UnexpectedToken,"ILLEGAL")}function z(){var e,n,r;if(w(S((r=c[f]).charCodeAt(0))||"."===r,"Numeric literal must start with a decimal digit or a decimal point"),n=f,e="","."!==r){if(e=c[f++],r=c[f],"0"===e){if("x"===r||"X"===r)return++f,function(e){for(var n="";f<d&&v(c[f]);)n+=c[f++];return 0===n.length&&Y({},a.UnexpectedToken,"ILLEGAL"),O(c.charCodeAt(f))&&Y({},a.UnexpectedToken,"ILLEGAL"),{type:t.NumericLiteral,value:parseInt("0x"+n,16),lineNumber:p,lineStart:h,start:e,end:f}}(n);if(A(r)&&function(){var e,t;for(e=f+1;e<d;++e){if("8"===(t=c[e])||"9"===t)return!1;if(!A(t))return!0}return!0}())return function(e){for(var n="0"+c[f++];f<d&&A(c[f]);)n+=c[f++];return(O(c.charCodeAt(f))||S(c.charCodeAt(f)))&&Y({},a.UnexpectedToken,"ILLEGAL"),{type:t.NumericLiteral,value:parseInt(n,8),octal:!0,lineNumber:p,lineStart:h,start:e,end:f}}(n)}for(;S(c.charCodeAt(f));)e+=c[f++];r=c[f]}if("."===r){for(e+=c[f++];S(c.charCodeAt(f));)e+=c[f++];r=c[f]}if("e"===r||"E"===r)if(e+=c[f++],"+"!==(r=c[f])&&"-"!==r||(e+=c[f++]),S(c.charCodeAt(f)))for(;S(c.charCodeAt(f));)e+=c[f++];else Y({},a.UnexpectedToken,"ILLEGAL");return O(c.charCodeAt(f))&&Y({},a.UnexpectedToken,"ILLEGAL"),{type:t.NumericLiteral,value:parseFloat(e),lineNumber:p,lineStart:h,start:n,end:f}}function R(){var e,n,r,o;return g=null,q(),e=f,n=function(){var e,t,n,r;for(w("/"===(e=c[f]),"Regular expression literal must start with a slash"),t=c[f++],n=!1,r=!1;f<d;)if(t+=e=c[f++],"\\"===e)N((e=c[f++]).charCodeAt(0))&&Y({},a.UnterminatedRegExp),t+=e;else if(N(e.charCodeAt(0)))Y({},a.UnterminatedRegExp);else if(n)"]"===e&&(n=!1);else{if("/"===e){r=!0;break}"["===e&&(n=!0)}return r||Y({},a.UnterminatedRegExp),{value:t.substr(1,t.length-2),literal:t}}(),r=function(){var e,t,n,r;for(t="",n="";f<d&&k((e=c[f]).charCodeAt(0));)if(++f,"\\"===e&&f<d)if("u"===(e=c[f])){if(r=++f,e=j("u"))for(n+=e,t+="\\u";r<f;++r)t+=c[r];else f=r,n+="u",t+="\\u";W({},a.UnexpectedToken,"ILLEGAL")}else t+="\\",W({},a.UnexpectedToken,"ILLEGAL");else n+=e,t+=e;return{value:n,literal:t}}(),o=function(e,t){var n;try{n=new RegExp(e,t)}catch(e){Y({},a.InvalidRegExp)}return n}(n.value,r.value),b.tokenize?{type:t.RegularExpression,value:o,lineNumber:p,lineStart:h,start:e,end:f}:{literal:n.literal+r.literal,value:o,start:e,end:f}}function D(){var e,t,n,r;return q(),e=f,t={start:{line:p,column:f-h}},n=R(),t.end={line:p,column:f-h},b.tokenize||(b.tokens.length>0&&(r=b.tokens[b.tokens.length-1]).range[0]===e&&"Punctuator"===r.type&&("/"!==r.value&&"/="!==r.value||b.tokens.pop()),b.tokens.push({type:"RegularExpression",value:n.literal,range:[e,f],loc:t})),n}function F(){var e;return q(),f>=d?{type:t.EOF,lineNumber:p,lineStart:h,start:f,end:f}:O(e=c.charCodeAt(f))?C():40===e||41===e||59===e?B():39===e||34===e?function(){var e,n,r,o,i,s,u,l,m="",g=!1;for(u=p,l=h,w("'"===(e=c[f])||'"'===e,"String literal must starts with a quote"),n=f,++f;f<d;){if((r=c[f++])===e){e="";break}if("\\"===r)if((r=c[f++])&&N(r.charCodeAt(0)))++p,"\r"===r&&"\n"===c[f]&&++f,h=f;else switch(r){case"u":case"x":s=f,(i=j(r))?m+=i:(f=s,m+=r);break;case"n":m+="\n";break;case"r":m+="\r";break;case"t":m+="\t";break;case"b":m+="\b";break;case"f":m+="\f";break;case"v":m+="\v";break;default:A(r)?(0!==(o="01234567".indexOf(r))&&(g=!0),f<d&&A(c[f])&&(g=!0,o=8*o+"01234567".indexOf(c[f++]),"0123".indexOf(r)>=0&&f<d&&A(c[f])&&(o=8*o+"01234567".indexOf(c[f++]))),m+=String.fromCharCode(o)):m+=r}else{if(N(r.charCodeAt(0)))break;m+=r}}return""!==e&&Y({},a.UnexpectedToken,"ILLEGAL"),{type:t.StringLiteral,value:m,octal:g,startLineNumber:u,startLineStart:l,lineNumber:p,lineStart:h,start:n,end:f}}():46===e?S(c.charCodeAt(f+1))?z():B():S(e)?z():b.tokenize&&47===e?function(){var e,t;if(!(e=b.tokens[b.tokens.length-1]))return D();if("Punctuator"===e.type){if("]"===e.value)return B();if(")"===e.value)return!(t=b.tokens[b.openParenToken-1])||"Keyword"!==t.type||"if"!==t.value&&"while"!==t.value&&"for"!==t.value&&"with"!==t.value?B():D();if("}"===e.value){if(b.tokens[b.openCurlyToken-3]&&"Keyword"===b.tokens[b.openCurlyToken-3].type){if(!(t=b.tokens[b.openCurlyToken-4]))return B()}else{if(!b.tokens[b.openCurlyToken-4]||"Keyword"!==b.tokens[b.openCurlyToken-4].type)return B();if(!(t=b.tokens[b.openCurlyToken-5]))return D()}return r.indexOf(t.value)>=0?B():D()}return D()}return"Keyword"===e.type&&"this"!==e.value?D():B()}():B()}function M(){var e,r,o;return q(),e={start:{line:p,column:f-h}},r=F(),e.end={line:p,column:f-h},r.type!==t.EOF&&(o=c.slice(r.start,r.end),b.tokens.push({type:n[r.type],value:o,range:[r.start,r.end],loc:e})),r}function U(){var e;return f=(e=g).end,p=e.lineNumber,h=e.lineStart,g=void 0!==b.tokens?M():F(),f=e.end,p=e.lineNumber,h=e.lineStart,e}function V(){var e,t,n;e=f,t=p,n=h,g=void 0!==b.tokens?M():F(),f=e,p=t,h=n}function G(e,t){this.line=e,this.column=t}function H(e,t,n,r){this.start=new G(e,t),this.end=new G(n,r)}function Q(){var e,t,n,r;return e=f,t=p,n=h,q(),r=p!==t,f=e,p=t,h=n,r}function Y(e,t){var n,r=Array.prototype.slice.call(arguments,2),o=t.replace(/%(\d)/g,(function(e,t){return w(t<r.length,"Message reference must be in range"),r[t]}));throw"number"==typeof e.lineNumber?((n=new Error("Line "+e.lineNumber+": "+o)).index=e.start,n.lineNumber=e.lineNumber,n.column=e.start-h+1):((n=new Error("Line "+p+": "+o)).index=f,n.lineNumber=p,n.column=f-h+1),n.description=o,n}function W(){try{Y.apply(null,arguments)}catch(e){if(!b.errors)throw e;b.errors.push(e)}}function K(e){if(e.type===t.EOF&&Y(e,a.UnexpectedEOS),e.type===t.NumericLiteral&&Y(e,a.UnexpectedNumber),e.type===t.StringLiteral&&Y(e,a.UnexpectedString),e.type===t.Identifier&&Y(e,a.UnexpectedIdentifier),e.type===t.Keyword){if(function(e){switch(e){case"class":case"enum":case"export":case"extends":case"import":case"super":return!0;default:return!1}}(e.value))Y(e,a.UnexpectedReserved);else if(l&&I(e.value))return void W(e,a.StrictReservedWord);Y(e,a.UnexpectedToken,e.value)}Y(e,a.UnexpectedToken,e.value)}function $(e){var n=U();n.type===t.Punctuator&&n.value===e||K(n)}function J(e){var n=U();n.type===t.Keyword&&n.value===e||K(n)}function X(e){return g.type===t.Punctuator&&g.value===e}function Z(e){return g.type===t.Keyword&&g.value===e}function ee(){var e,n=f,r=p,o=h,i=g;if(59===c.charCodeAt(f)||X(";"))U();else{if(e=p,q(),p!==e)return f=n,p=r,h=o,void(g=i);g.type===t.EOF||X("}")||K(g)}}function te(e){return e.type===o.Identifier||e.type===o.MemberExpression}function ne(e,t){var n,r,o;return n=l,o=g,r=Oe(),t&&l&&x(e[0].name)&&W(t,a.StrictParamName),l=n,m.markEnd(m.createFunctionExpression(null,e,[],r),o)}function re(){var e,n;return n=g,(e=U()).type===t.StringLiteral||e.type===t.NumericLiteral?(l&&e.octal&&W(e,a.StrictOctalLiteral),m.markEnd(m.createLiteral(e),n)):m.markEnd(m.createIdentifier(e.value),n)}function oe(){var e,n,r,o,i,s;return s=g,(e=g).type===t.Identifier?(r=re(),"get"!==e.value||X(":")?"set"!==e.value||X(":")?($(":"),o=me(),m.markEnd(m.createProperty("init",r,o),s)):(n=re(),$("("),(e=g).type!==t.Identifier?($(")"),W(e,a.UnexpectedToken,e.value),o=ne([])):(i=[be()],$(")"),o=ne(i,e)),m.markEnd(m.createProperty("set",n,o),s)):(n=re(),$("("),$(")"),o=ne([]),m.markEnd(m.createProperty("get",n,o),s))):e.type!==t.EOF&&e.type!==t.Punctuator?(n=re(),$(":"),o=me(),m.markEnd(m.createProperty("init",n,o),s)):void K(e)}function ie(){var e,n,r,s;if(X("("))return function(){var e;return $("("),e=ge(),$(")"),e}();if(X("["))return function(){var e,t=[];for(e=g,$("[");!X("]");)X(",")?(U(),t.push(null)):(t.push(me()),X("]")||$(","));return U(),m.markEnd(m.createArrayExpression(t),e)}();if(X("{"))return function(){var e,t,n,r,s,u=[],c={},f=String;for(s=g,$("{");!X("}");)t=(e=oe()).key.type===o.Identifier?e.key.name:f(e.key.value),r="init"===e.kind?i.Data:"get"===e.kind?i.Get:i.Set,n="$"+t,Object.prototype.hasOwnProperty.call(c,n)?(c[n]===i.Data?l&&r===i.Data?W({},a.StrictDuplicateProperty):r!==i.Data&&W({},a.AccessorDataProperty):r===i.Data?W({},a.AccessorDataProperty):c[n]&r&&W({},a.AccessorGetSet),c[n]|=r):c[n]=r,u.push(e),X("}")||$(",");return $("}"),m.markEnd(m.createObjectExpression(u),s)}();if(e=g.type,s=g,e===t.Identifier)r=m.createIdentifier(U().value);else if(e===t.StringLiteral||e===t.NumericLiteral)l&&g.octal&&W(g,a.StrictOctalLiteral),r=m.createLiteral(U());else if(e===t.Keyword){if(Z("function"))return function(){var e,t,n,r,o,i,s,u,c,f=null;c=g,J("function"),X("(")||(e=g,f=be(),l?x(e.value)&&W(e,a.StrictFunctionName):x(e.value)?(n=e,r=a.StrictFunctionName):I(e.value)&&(n=e,r=a.StrictReservedWord));o=ke(n),i=o.params,t=o.stricted,n=o.firstRestricted,o.message&&(r=o.message);u=l,s=Oe(),l&&n&&Y(n,r);l&&t&&W(t,r);return l=u,m.markEnd(m.createFunctionExpression(f,i,[],s),c)}();Z("this")?(U(),r=m.createThisExpression()):K(U())}else e===t.BooleanLiteral?((n=U()).value="true"===n.value,r=m.createLiteral(n)):e===t.NullLiteral?((n=U()).value=null,r=m.createLiteral(n)):X("/")||X("/=")?(r=void 0!==b.tokens?m.createLiteral(D()):m.createLiteral(R()),V()):K(U());return m.markEnd(r,s)}function ae(){var e=[];if($("("),!X(")"))for(;f<d&&(e.push(me()),!X(")"));)$(",");return $(")"),e}function se(){var e,n;return n=g,function(e){return e.type===t.Identifier||e.type===t.Keyword||e.type===t.BooleanLiteral||e.type===t.NullLiteral}(e=U())||K(e),m.markEnd(m.createIdentifier(e.value),n)}function ue(){return $("."),se()}function ce(){var e;return $("["),e=ge(),$("]"),e}function le(){var e,t,n;return n=g,J("new"),e=function(){var e,t,n;w(y.allowIn,"callee of new expression always allow in keyword."),n=g,e=Z("new")?le():ie();for(;X(".")||X("[");)X("[")?(t=ce(),e=m.createMemberExpression("[",e,t)):(t=ue(),e=m.createMemberExpression(".",e,t)),m.markEnd(e,n);return e}(),t=X("(")?ae():[],m.markEnd(m.createNewExpression(e,t),n)}function fe(){var e,n,r=g;return e=function(){var e,t,n,r,o=y.allowIn;for(r=g,y.allowIn=!0,e=Z("new")?le():ie();;){if(X("."))n=ue(),e=m.createMemberExpression(".",e,n);else if(X("("))t=ae(),e=m.createCallExpression(e,t);else{if(!X("["))break;n=ce(),e=m.createMemberExpression("[",e,n)}m.markEnd(e,r)}return y.allowIn=o,e}(),g.type===t.Punctuator&&(!X("++")&&!X("--")||Q()||(l&&e.type===o.Identifier&&x(e.name)&&W({},a.StrictLHSPostfix),te(e)||W({},a.InvalidLHSInAssignment),n=U(),e=m.markEnd(m.createPostfixExpression(n.value,e),r))),e}function pe(){var e,n,r;return g.type!==t.Punctuator&&g.type!==t.Keyword?n=fe():X("++")||X("--")?(r=g,e=U(),n=pe(),l&&n.type===o.Identifier&&x(n.name)&&W({},a.StrictLHSPrefix),te(n)||W({},a.InvalidLHSInAssignment),n=m.createUnaryExpression(e.value,n),n=m.markEnd(n,r)):X("+")||X("-")||X("~")||X("!")?(r=g,e=U(),n=pe(),n=m.createUnaryExpression(e.value,n),n=m.markEnd(n,r)):Z("delete")||Z("void")||Z("typeof")?(r=g,e=U(),n=pe(),n=m.createUnaryExpression(e.value,n),n=m.markEnd(n,r),l&&"delete"===n.operator&&n.argument.type===o.Identifier&&W({},a.StrictDelete)):n=fe(),n}function he(e,n){var r=0;if(e.type!==t.Punctuator&&e.type!==t.Keyword)return 0;switch(e.value){case"||":r=1;break;case"&&":r=2;break;case"|":r=3;break;case"^":r=4;break;case"&":r=5;break;case"==":case"!=":case"===":case"!==":r=6;break;case"<":case">":case"<=":case">=":case"instanceof":r=7;break;case"in":r=n?7:0;break;case"<<":case">>":case">>>":r=8;break;case"+":case"-":r=9;break;case"*":case"/":case"%":r=11}return r}function de(){var e,t,n,r,o;return o=g,e=function(){var e,t,n,r,o,i,a,s,u,c;if(e=g,u=pe(),0===(o=he(r=g,y.allowIn)))return u;for(r.prec=o,U(),t=[e,g],i=[u,r,a=pe()];(o=he(g,y.allowIn))>0;){for(;i.length>2&&o<=i[i.length-2].prec;)a=i.pop(),s=i.pop().value,u=i.pop(),n=m.createBinaryExpression(s,u,a),t.pop(),e=t[t.length-1],m.markEnd(n,e),i.push(n);(r=U()).prec=o,i.push(r),t.push(g),n=pe(),i.push(n)}for(n=i[c=i.length-1],t.pop();c>1;)n=m.createBinaryExpression(i[c-1].value,i[c-2],n),c-=2,e=t.pop(),m.markEnd(n,e);return n}(),X("?")&&(U(),t=y.allowIn,y.allowIn=!0,n=me(),y.allowIn=t,$(":"),r=me(),e=m.createConditionalExpression(e,n,r),m.markEnd(e,o)),e}function me(){var e,n,r,i,s,u;return e=g,s=g,i=n=de(),g.type!==t.Punctuator||"="!==(u=g.value)&&"*="!==u&&"/="!==u&&"%="!==u&&"+="!==u&&"-="!==u&&"<<="!==u&&">>="!==u&&">>>="!==u&&"&="!==u&&"^="!==u&&"|="!==u||(te(n)||W({},a.InvalidLHSInAssignment),l&&n.type===o.Identifier&&x(n.name)&&W(e,a.StrictLHSAssignment),e=U(),r=me(),i=m.markEnd(m.createAssignmentExpression(e.value,n,r),s)),i}function ge(){var e,t=g;if(e=me(),X(",")){for(e=m.createSequenceExpression([e]);f<d&&X(",");)U(),e.expressions.push(me());m.markEnd(e,t)}return e}function ye(){var e,t;return t=g,$("{"),e=function(){for(var e,t=[];f<d&&!X("}")&&void 0!==(e=xe());)t.push(e);return t}(),$("}"),m.markEnd(m.createBlockStatement(e),t)}function be(){var e,n;return n=g,(e=U()).type!==t.Identifier&&K(e),m.markEnd(m.createIdentifier(e.value),n)}function we(e){var t,n,r=null;return n=g,t=be(),l&&x(t.name)&&W({},a.StrictVarName),"const"===e?($("="),r=me()):X("=")&&(U(),r=me()),m.markEnd(m.createVariableDeclarator(t,r),n)}function Se(e){var t=[];do{if(t.push(we(e)),!X(","))break;U()}while(f<d);return t}function ve(){var e,t,n,r,o,i,s,u,c,l,f=y.allowIn;return e=t=n=null,J("for"),$("("),X(";")?U():(Z("var")||Z("let")?(y.allowIn=!1,l=g,u=U(),c=Se(),e=m.markEnd(m.createVariableDeclaration(c,u.value),l),y.allowIn=f,1===e.declarations.length&&Z("in")&&(U(),r=e,o=ge(),e=null)):(y.allowIn=!1,e=ge(),y.allowIn=f,Z("in")&&(te(e)||W({},a.InvalidLHSInForIn),U(),r=e,o=ge(),e=null)),void 0===r&&$(";")),void 0===r&&(X(";")||(t=ge()),$(";"),X(")")||(n=ge())),$(")"),s=y.inIteration,y.inIteration=!0,i=Ne(),y.inIteration=s,void 0===r?m.createForStatement(e,t,n,i):m.createForInStatement(r,o,i)}function Ae(){var e,t,n,r=[];for(n=g,Z("default")?(U(),e=null):(J("case"),e=ge()),$(":");f<d&&!(X("}")||Z("default")||Z("case"));)t=Ne(),r.push(t);return m.markEnd(m.createSwitchCase(e,r),n)}function _e(){var e,t,n,r,o=[],i=null;return J("try"),e=ye(),Z("catch")&&o.push((r=g,J("catch"),$("("),X(")")&&K(g),t=be(),l&&x(t.name)&&W({},a.StrictCatchVariable),$(")"),n=ye(),m.markEnd(m.createCatchClause(t,n),r))),Z("finally")&&(U(),i=ye()),0!==o.length||i||Y({},a.NoCatchOrFinally),m.createTryStatement(e,[],o,i)}function Ne(){var e,n,r,i,s,u,p,h,b,w=g.type;if(w===t.EOF&&K(g),w===t.Punctuator&&"{"===g.value)return ye();if(i=g,w===t.Punctuator)switch(g.value){case";":return m.markEnd(($(";"),m.createEmptyStatement()),i);case"(":return m.markEnd(function(){var e=ge();return ee(),m.createExpressionStatement(e)}(),i)}if(w===t.Keyword)switch(g.value){case"break":return m.markEnd(function(){var e,n=null;return J("break"),59===c.charCodeAt(f)?(U(),y.inIteration||y.inSwitch||Y({},a.IllegalBreak),m.createBreakStatement(null)):Q()?(y.inIteration||y.inSwitch||Y({},a.IllegalBreak),m.createBreakStatement(null)):(g.type===t.Identifier&&(e="$"+(n=be()).name,Object.prototype.hasOwnProperty.call(y.labelSet,e)||Y({},a.UnknownLabel,n.name)),ee(),null!==n||y.inIteration||y.inSwitch||Y({},a.IllegalBreak),m.createBreakStatement(n))}(),i);case"continue":return m.markEnd(function(){var e,n=null;return J("continue"),59===c.charCodeAt(f)?(U(),y.inIteration||Y({},a.IllegalContinue),m.createContinueStatement(null)):Q()?(y.inIteration||Y({},a.IllegalContinue),m.createContinueStatement(null)):(g.type===t.Identifier&&(e="$"+(n=be()).name,Object.prototype.hasOwnProperty.call(y.labelSet,e)||Y({},a.UnknownLabel,n.name)),ee(),null!==n||y.inIteration||Y({},a.IllegalContinue),m.createContinueStatement(n))}(),i);case"debugger":return m.markEnd((J("debugger"),ee(),m.createDebuggerStatement()),i);case"do":return m.markEnd((J("do"),b=y.inIteration,y.inIteration=!0,p=Ne(),y.inIteration=b,J("while"),$("("),h=ge(),$(")"),X(";")&&U(),m.createDoWhileStatement(p,h)),i);case"for":return m.markEnd(ve(),i);case"function":return m.markEnd(Ie(),i);case"if":return m.markEnd(function(){var e,t,n;return J("if"),$("("),e=ge(),$(")"),t=Ne(),Z("else")?(U(),n=Ne()):n=null,m.createIfStatement(e,t,n)}(),i);case"return":return m.markEnd((u=null,J("return"),y.inFunctionBody||W({},a.IllegalReturn),32===c.charCodeAt(f)&&O(c.charCodeAt(f+1))?(u=ge(),ee(),m.createReturnStatement(u)):Q()?m.createReturnStatement(null):(X(";")||X("}")||g.type===t.EOF||(u=ge()),ee(),m.createReturnStatement(u))),i);case"switch":return m.markEnd(function(){var e,t,n,r,o;if(J("switch"),$("("),e=ge(),$(")"),$("{"),t=[],X("}"))return U(),m.createSwitchStatement(e,t);for(r=y.inSwitch,y.inSwitch=!0,o=!1;f<d&&!X("}");)null===(n=Ae()).test&&(o&&Y({},a.MultipleDefaultsInSwitch),o=!0),t.push(n);return y.inSwitch=r,$("}"),m.createSwitchStatement(e,t)}(),i);case"throw":return m.markEnd(function(){var e;return J("throw"),Q()&&Y({},a.NewlineAfterThrow),e=ge(),ee(),m.createThrowStatement(e)}(),i);case"try":return m.markEnd(_e(),i);case"var":return m.markEnd((J("var"),s=Se(),ee(),m.createVariableDeclaration(s,"var")),i);case"while":return m.markEnd(function(){var e,t,n;return J("while"),$("("),e=ge(),$(")"),n=y.inIteration,y.inIteration=!0,t=Ne(),y.inIteration=n,m.createWhileStatement(e,t)}(),i);case"with":return m.markEnd(function(){var e,t;return l&&(q(),W({},a.StrictModeWith)),J("with"),$("("),e=ge(),$(")"),t=Ne(),m.createWithStatement(e,t)}(),i)}return(e=ge()).type===o.Identifier&&X(":")?(U(),r="$"+e.name,Object.prototype.hasOwnProperty.call(y.labelSet,r)&&Y({},a.Redeclaration,"Label",e.name),y.labelSet[r]=!0,n=Ne(),delete y.labelSet[r],m.markEnd(m.createLabeledStatement(e,n),i)):(ee(),m.markEnd(m.createExpressionStatement(e),i))}function Oe(){var e,n,r,i,s,u,p,h,b=[];for(h=g,$("{");f<d&&g.type===t.StringLiteral&&(n=g,e=xe(),b.push(e),e.expression.type===o.Literal);)"use strict"===c.slice(n.start+1,n.end-1)?(l=!0,r&&W(r,a.StrictOctalLiteral)):!r&&n.octal&&(r=n);for(i=y.labelSet,s=y.inIteration,u=y.inSwitch,p=y.inFunctionBody,y.labelSet={},y.inIteration=!1,y.inSwitch=!1,y.inFunctionBody=!0;f<d&&!X("}")&&void 0!==(e=xe());)b.push(e);return $("}"),y.labelSet=i,y.inIteration=s,y.inSwitch=u,y.inFunctionBody=p,m.markEnd(m.createBlockStatement(b),h)}function ke(e){var t,n,r,o,i,s,u=[];if($("("),!X(")"))for(o={};f<d&&(n=g,t=be(),i="$"+n.value,l?(x(n.value)&&(r=n,s=a.StrictParamName),Object.prototype.hasOwnProperty.call(o,i)&&(r=n,s=a.StrictParamDupe)):e||(x(n.value)?(e=n,s=a.StrictParamName):I(n.value)?(e=n,s=a.StrictReservedWord):Object.prototype.hasOwnProperty.call(o,i)&&(e=n,s=a.StrictParamDupe)),u.push(t),o[i]=!0,!X(")"));)$(",");return $(")"),{params:u,stricted:r,firstRestricted:e,message:s}}function Ie(){var e,t,n,r,o,i,s,u,c,f;return f=g,J("function"),r=g,e=be(),l?x(r.value)&&W(r,a.StrictFunctionName):x(r.value)?(s=r,u=a.StrictFunctionName):I(r.value)&&(s=r,u=a.StrictReservedWord),t=(i=ke(s)).params,o=i.stricted,s=i.firstRestricted,i.message&&(u=i.message),c=l,n=Oe(),l&&s&&Y(s,u),l&&o&&W(o,u),l=c,m.markEnd(m.createFunctionDeclaration(e,t,[],n),f)}function xe(){if(g.type===t.Keyword)switch(g.value){case"const":case"let":return e=g.value,r=g,J(e),n=Se(e),ee(),m.markEnd(m.createVariableDeclaration(n,e),r);case"function":return Ie();default:return Ne()}var e,n,r;if(g.type!==t.EOF)return Ne()}function Pe(){var e,n;return q(),V(),n=g,l=!1,e=function(){for(var e,n,r,i=[];f<d&&(n=g).type===t.StringLiteral&&(e=xe(),i.push(e),e.expression.type===o.Literal);)"use strict"===c.slice(n.start+1,n.end-1)?(l=!0,r&&W(r,a.StrictOctalLiteral)):!r&&n.octal&&(r=n);for(;f<d&&void 0!==(e=xe());)i.push(e);return i}(),m.markEnd(m.createProgram(e),n)}function Ee(){var e,t,n,r=[];for(e=0;e<b.tokens.length;++e)n={type:(t=b.tokens[e]).type,value:t.value},b.range&&(n.range=t.range),b.loc&&(n.loc=t.loc),r.push(n);b.tokens=r}(n={})[(t={BooleanLiteral:1,EOF:2,Identifier:3,Keyword:4,NullLiteral:5,NumericLiteral:6,Punctuator:7,StringLiteral:8,RegularExpression:9}).BooleanLiteral]="Boolean",n[t.EOF]="<end>",n[t.Identifier]="Identifier",n[t.Keyword]="Keyword",n[t.NullLiteral]="Null",n[t.NumericLiteral]="Numeric",n[t.Punctuator]="Punctuator",n[t.StringLiteral]="String",n[t.RegularExpression]="RegularExpression",r=["(","{","[","in","typeof","instanceof","new","return","case","delete","throw","void","=","+=","-=","*=","/=","%=","<<=",">>=",">>>=","&=","|=","^=",",","+","-","*","/","%","++","--","<<",">>",">>>","&","|","^","!","~","&&","||","?",":","===","==",">=","<=","<",">","!=","!=="],o={AssignmentExpression:"AssignmentExpression",ArrayExpression:"ArrayExpression",BlockStatement:"BlockStatement",BinaryExpression:"BinaryExpression",BreakStatement:"BreakStatement",CallExpression:"CallExpression",CatchClause:"CatchClause",ConditionalExpression:"ConditionalExpression",ContinueStatement:"ContinueStatement",DoWhileStatement:"DoWhileStatement",DebuggerStatement:"DebuggerStatement",EmptyStatement:"EmptyStatement",ExpressionStatement:"ExpressionStatement",ForStatement:"ForStatement",ForInStatement:"ForInStatement",FunctionDeclaration:"FunctionDeclaration",FunctionExpression:"FunctionExpression",Identifier:"Identifier",IfStatement:"IfStatement",Literal:"Literal",LabeledStatement:"LabeledStatement",LogicalExpression:"LogicalExpression",MemberExpression:"MemberExpression",NewExpression:"NewExpression",ObjectExpression:"ObjectExpression",Program:"Program",Property:"Property",ReturnStatement:"ReturnStatement",SequenceExpression:"SequenceExpression",SwitchStatement:"SwitchStatement",SwitchCase:"SwitchCase",ThisExpression:"ThisExpression",ThrowStatement:"ThrowStatement",TryStatement:"TryStatement",UnaryExpression:"UnaryExpression",UpdateExpression:"UpdateExpression",VariableDeclaration:"VariableDeclaration",VariableDeclarator:"VariableDeclarator",WhileStatement:"WhileStatement",WithStatement:"WithStatement"},i={Data:1,Get:2,Set:4},a={UnexpectedToken:"Unexpected token %0",UnexpectedNumber:"Unexpected number",UnexpectedString:"Unexpected string",UnexpectedIdentifier:"Unexpected identifier",UnexpectedReserved:"Unexpected reserved word",UnexpectedEOS:"Unexpected end of input",NewlineAfterThrow:"Illegal newline after throw",InvalidRegExp:"Invalid regular expression",UnterminatedRegExp:"Invalid regular expression: missing /",InvalidLHSInAssignment:"Invalid left-hand side in assignment",InvalidLHSInForIn:"Invalid left-hand side in for-in",MultipleDefaultsInSwitch:"More than one default clause in switch statement",NoCatchOrFinally:"Missing catch or finally after try",UnknownLabel:"Undefined label '%0'",Redeclaration:"%0 '%1' has already been declared",IllegalContinue:"Illegal continue statement",IllegalBreak:"Illegal break statement",IllegalReturn:"Illegal return statement",StrictModeWith:"Strict mode code may not include a with statement",StrictCatchVariable:"Catch variable may not be eval or arguments in strict mode",StrictVarName:"Variable name may not be eval or arguments in strict mode",StrictParamName:"Parameter name eval or arguments is not allowed in strict mode",StrictParamDupe:"Strict mode function may not have duplicate parameter names",StrictFunctionName:"Function name may not be eval or arguments in strict mode",StrictOctalLiteral:"Octal literals are not allowed in strict mode.",StrictDelete:"Delete of an unqualified identifier in strict mode.",StrictDuplicateProperty:"Duplicate data property in object literal not allowed in strict mode",AccessorDataProperty:"Object literal may not have data and accessor property with the same name",AccessorGetSet:"Object literal may not have multiple get/set accessors with the same name",StrictLHSAssignment:"Assignment to eval or arguments is not allowed in strict mode",StrictLHSPostfix:"Postfix increment/decrement may not have eval or arguments operand in strict mode",StrictLHSPrefix:"Prefix increment/decrement may not have eval or arguments operand in strict mode",StrictReservedWord:"Use of future reserved word in strict mode"},s={NonAsciiIdentifierStart:new RegExp("[ªµºÀ-ÖØ-öø-ˁˆ-ˑˠ-ˤˬˮͰ-ʹͶͷͺ-ͽΆΈ-ΊΌΎ-ΡΣ-ϵϷ-ҁҊ-ԧԱ-Ֆՙա-ևא-תװ-ײؠ-يٮٯٱ-ۓەۥۦۮۯۺ-ۼۿܐܒ-ܯݍ-ޥޱߊ-ߪߴߵߺࠀ-ࠕࠚࠤࠨࡀ-ࡘࢠࢢ-ࢬऄ-हऽॐक़-ॡॱ-ॷॹ-ॿঅ-ঌএঐও-নপ-রলশ-হঽৎড়ঢ়য়-ৡৰৱਅ-ਊਏਐਓ-ਨਪ-ਰਲਲ਼ਵਸ਼ਸਹਖ਼-ੜਫ਼ੲ-ੴઅ-ઍએ-ઑઓ-નપ-રલળવ-હઽૐૠૡଅ-ଌଏଐଓ-ନପ-ରଲଳଵ-ହଽଡ଼ଢ଼ୟ-ୡୱஃஅ-ஊஎ-ஐஒ-கஙசஜஞடணதந-பம-ஹௐఅ-ఌఎ-ఐఒ-నప-ళవ-హఽౘౙౠౡಅ-ಌಎ-ಐಒ-ನಪ-ಳವ-ಹಽೞೠೡೱೲഅ-ഌഎ-ഐഒ-ഺഽൎൠൡൺ-ൿඅ-ඖක-නඳ-රලව-ෆก-ะาำเ-ๆກຂຄງຈຊຍດ-ທນ-ຟມ-ຣລວສຫອ-ະາຳຽເ-ໄໆໜ-ໟༀཀ-ཇཉ-ཬྈ-ྌက-ဪဿၐ-ၕၚ-ၝၡၥၦၮ-ၰၵ-ႁႎႠ-ჅჇჍა-ჺჼ-ቈቊ-ቍቐ-ቖቘቚ-ቝበ-ኈኊ-ኍነ-ኰኲ-ኵኸ-ኾዀዂ-ዅወ-ዖዘ-ጐጒ-ጕጘ-ፚᎀ-ᎏᎠ-Ᏼᐁ-ᙬᙯ-ᙿᚁ-ᚚᚠ-ᛪᛮ-ᛰᜀ-ᜌᜎ-ᜑᜠ-ᜱᝀ-ᝑᝠ-ᝬᝮ-ᝰក-ឳៗៜᠠ-ᡷᢀ-ᢨᢪᢰ-ᣵᤀ-ᤜᥐ-ᥭᥰ-ᥴᦀ-ᦫᧁ-ᧇᨀ-ᨖᨠ-ᩔᪧᬅ-ᬳᭅ-ᭋᮃ-ᮠᮮᮯᮺ-ᯥᰀ-ᰣᱍ-ᱏᱚ-ᱽᳩ-ᳬᳮ-ᳱᳵᳶᴀ-ᶿḀ-ἕἘ-Ἕἠ-ὅὈ-Ὅὐ-ὗὙὛὝὟ-ώᾀ-ᾴᾶ-ᾼιῂ-ῄῆ-ῌῐ-ΐῖ-Ίῠ-Ῥῲ-ῴῶ-ῼⁱⁿₐ-ₜℂℇℊ-ℓℕℙ-ℝℤΩℨK-ℭℯ-ℹℼ-ℿⅅ-ⅉⅎⅠ-ↈⰀ-Ⱞⰰ-ⱞⱠ-ⳤⳫ-ⳮⳲⳳⴀ-ⴥⴧⴭⴰ-ⵧⵯⶀ-ⶖⶠ-ⶦⶨ-ⶮⶰ-ⶶⶸ-ⶾⷀ-ⷆⷈ-ⷎⷐ-ⷖⷘ-ⷞⸯ々-〇〡-〩〱-〵〸-〼ぁ-ゖゝ-ゟァ-ヺー-ヿㄅ-ㄭㄱ-ㆎㆠ-ㆺㇰ-ㇿ㐀-䶵一-鿌ꀀ-ꒌꓐ-ꓽꔀ-ꘌꘐ-ꘟꘪꘫꙀ-ꙮꙿ-ꚗꚠ-ꛯꜗ-ꜟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꠁꠃ-ꠅꠇ-ꠊꠌ-ꠢꡀ-ꡳꢂ-ꢳꣲ-ꣷꣻꤊ-ꤥꤰ-ꥆꥠ-ꥼꦄ-ꦲꧏꨀ-ꨨꩀ-ꩂꩄ-ꩋꩠ-ꩶꩺꪀ-ꪯꪱꪵꪶꪹ-ꪽꫀꫂꫛ-ꫝꫠ-ꫪꫲ-ꫴꬁ-ꬆꬉ-ꬎꬑ-ꬖꬠ-ꬦꬨ-ꬮꯀ-ꯢ가-힣ힰ-ퟆퟋ-ퟻ豈-舘並-龎ﬀ-ﬆﬓ-ﬗיִײַ-ﬨשׁ-זּטּ-לּמּנּסּףּפּצּ-ﮱﯓ-ﴽﵐ-ﶏﶒ-ﷇﷰ-ﷻﹰ-ﹴﹶ-ﻼＡ-Ｚａ-ｚｦ-ﾾￂ-ￇￊ-ￏￒ-ￗￚ-ￜ]"),NonAsciiIdentifierPart:new RegExp("[ªµºÀ-ÖØ-öø-ˁˆ-ˑˠ-ˤˬˮ̀-ʹͶͷͺ-ͽΆΈ-ΊΌΎ-ΡΣ-ϵϷ-ҁ҃-҇Ҋ-ԧԱ-Ֆՙա-և֑-ׇֽֿׁׂׅׄא-תװ-ײؐ-ؚؠ-٩ٮ-ۓە-ۜ۟-۪ۨ-ۼۿܐ-݊ݍ-ޱ߀-ߵߺࠀ-࠭ࡀ-࡛ࢠࢢ-ࢬࣤ-ࣾऀ-ॣ०-९ॱ-ॷॹ-ॿঁ-ঃঅ-ঌএঐও-নপ-রলশ-হ়-ৄেৈো-ৎৗড়ঢ়য়-ৣ০-ৱਁ-ਃਅ-ਊਏਐਓ-ਨਪ-ਰਲਲ਼ਵਸ਼ਸਹ਼ਾ-ੂੇੈੋ-੍ੑਖ਼-ੜਫ਼੦-ੵઁ-ઃઅ-ઍએ-ઑઓ-નપ-રલળવ-હ઼-ૅે-ૉો-્ૐૠ-ૣ૦-૯ଁ-ଃଅ-ଌଏଐଓ-ନପ-ରଲଳଵ-ହ଼-ୄେୈୋ-୍ୖୗଡ଼ଢ଼ୟ-ୣ୦-୯ୱஂஃஅ-ஊஎ-ஐஒ-கஙசஜஞடணதந-பம-ஹா-ூெ-ைொ-்ௐௗ௦-௯ఁ-ఃఅ-ఌఎ-ఐఒ-నప-ళవ-హఽ-ౄె-ైొ-్ౕౖౘౙౠ-ౣ౦-౯ಂಃಅ-ಌಎ-ಐಒ-ನಪ-ಳವ-ಹ಼-ೄೆ-ೈೊ-್ೕೖೞೠ-ೣ೦-೯ೱೲംഃഅ-ഌഎ-ഐഒ-ഺഽ-ൄെ-ൈൊ-ൎൗൠ-ൣ൦-൯ൺ-ൿංඃඅ-ඖක-නඳ-රලව-ෆ්ා-ුූෘ-ෟෲෳก-ฺเ-๎๐-๙ກຂຄງຈຊຍດ-ທນ-ຟມ-ຣລວສຫອ-ູົ-ຽເ-ໄໆ່-ໍ໐-໙ໜ-ໟༀ༘༙༠-༩༹༵༷༾-ཇཉ-ཬཱ-྄྆-ྗྙ-ྼ࿆က-၉ၐ-ႝႠ-ჅჇჍა-ჺჼ-ቈቊ-ቍቐ-ቖቘቚ-ቝበ-ኈኊ-ኍነ-ኰኲ-ኵኸ-ኾዀዂ-ዅወ-ዖዘ-ጐጒ-ጕጘ-ፚ፝-፟ᎀ-ᎏᎠ-Ᏼᐁ-ᙬᙯ-ᙿᚁ-ᚚᚠ-ᛪᛮ-ᛰᜀ-ᜌᜎ-᜔ᜠ-᜴ᝀ-ᝓᝠ-ᝬᝮ-ᝰᝲᝳក-៓ៗៜ៝០-៩᠋-᠍᠐-᠙ᠠ-ᡷᢀ-ᢪᢰ-ᣵᤀ-ᤜᤠ-ᤫᤰ-᤻᥆-ᥭᥰ-ᥴᦀ-ᦫᦰ-ᧉ᧐-᧙ᨀ-ᨛᨠ-ᩞ᩠-᩿᩼-᪉᪐-᪙ᪧᬀ-ᭋ᭐-᭙᭫-᭳ᮀ-᯳ᰀ-᰷᱀-᱉ᱍ-ᱽ᳐-᳔᳒-ᳶᴀ-ᷦ᷼-ἕἘ-Ἕἠ-ὅὈ-Ὅὐ-ὗὙὛὝὟ-ώᾀ-ᾴᾶ-ᾼιῂ-ῄῆ-ῌῐ-ΐῖ-Ίῠ-Ῥῲ-ῴῶ-ῼ‌‍‿⁀⁔ⁱⁿₐ-ₜ⃐-⃥⃜⃡-⃰ℂℇℊ-ℓℕℙ-ℝℤΩℨK-ℭℯ-ℹℼ-ℿⅅ-ⅉⅎⅠ-ↈⰀ-Ⱞⰰ-ⱞⱠ-ⳤⳫ-ⳳⴀ-ⴥⴧⴭⴰ-ⵧⵯ⵿-ⶖⶠ-ⶦⶨ-ⶮⶰ-ⶶⶸ-ⶾⷀ-ⷆⷈ-ⷎⷐ-ⷖⷘ-ⷞⷠ-ⷿⸯ々-〇〡-〯〱-〵〸-〼ぁ-ゖ゙゚ゝ-ゟァ-ヺー-ヿㄅ-ㄭㄱ-ㆎㆠ-ㆺㇰ-ㇿ㐀-䶵一-鿌ꀀ-ꒌꓐ-ꓽꔀ-ꘌꘐ-ꘫꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟ-꛱ꜗ-ꜟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꠧꡀ-ꡳꢀ-꣄꣐-꣙꣠-ꣷꣻ꤀-꤭ꤰ-꥓ꥠ-ꥼꦀ-꧀ꧏ-꧙ꨀ-ꨶꩀ-ꩍ꩐-꩙ꩠ-ꩶꩺꩻꪀ-ꫂꫛ-ꫝꫠ-ꫯꫲ-꫶ꬁ-ꬆꬉ-ꬎꬑ-ꬖꬠ-ꬦꬨ-ꬮꯀ-ꯪ꯬꯭꯰-꯹가-힣ힰ-ퟆퟋ-ퟻ豈-舘並-龎ﬀ-ﬆﬓ-ﬗיִ-ﬨשׁ-זּטּ-לּמּנּסּףּפּצּ-ﮱﯓ-ﴽﵐ-ﶏﶒ-ﷇﷰ-ﷻ︀-️︠-︦︳︴﹍-﹏ﹰ-ﹴﹶ-ﻼ０-９Ａ-Ｚ＿ａ-ｚｦ-ﾾￂ-ￇￊ-ￏￒ-ￗￚ-ￜ]")},u={name:"SyntaxTree",processComment:function(e){var t,n;if(!(e.type===o.Program&&e.body.length>0)){for(b.trailingComments.length>0?b.trailingComments[0].range[0]>=e.range[1]?(n=b.trailingComments,b.trailingComments=[]):b.trailingComments.length=0:b.bottomRightStack.length>0&&b.bottomRightStack[b.bottomRightStack.length-1].trailingComments&&b.bottomRightStack[b.bottomRightStack.length-1].trailingComments[0].range[0]>=e.range[1]&&(n=b.bottomRightStack[b.bottomRightStack.length-1].trailingComments,delete b.bottomRightStack[b.bottomRightStack.length-1].trailingComments);b.bottomRightStack.length>0&&b.bottomRightStack[b.bottomRightStack.length-1].range[0]>=e.range[0];)t=b.bottomRightStack.pop();t?t.leadingComments&&t.leadingComments[t.leadingComments.length-1].range[1]<=e.range[0]&&(e.leadingComments=t.leadingComments,delete t.leadingComments):b.leadingComments.length>0&&b.leadingComments[b.leadingComments.length-1].range[1]<=e.range[0]&&(e.leadingComments=b.leadingComments,b.leadingComments=[]),n&&(e.trailingComments=n),b.bottomRightStack.push(e)}},markEnd:function(e,t){return b.range&&(e.range=[t.start,f]),b.loc&&(e.loc=new H(void 0===t.startLineNumber?t.lineNumber:t.startLineNumber,t.start-(void 0===t.startLineStart?t.lineStart:t.startLineStart),p,f-h),this.postProcess(e)),b.attachComment&&this.processComment(e),e},postProcess:function(e){return b.source&&(e.loc.source=b.source),e},createArrayExpression:function(e){return{type:o.ArrayExpression,elements:e}},createAssignmentExpression:function(e,t,n){return{type:o.AssignmentExpression,operator:e,left:t,right:n}},createBinaryExpression:function(e,t,n){return{type:"||"===e||"&&"===e?o.LogicalExpression:o.BinaryExpression,operator:e,left:t,right:n}},createBlockStatement:function(e){return{type:o.BlockStatement,body:e}},createBreakStatement:function(e){return{type:o.BreakStatement,label:e}},createCallExpression:function(e,t){return{type:o.CallExpression,callee:e,arguments:t}},createCatchClause:function(e,t){return{type:o.CatchClause,param:e,body:t}},createConditionalExpression:function(e,t,n){return{type:o.ConditionalExpression,test:e,consequent:t,alternate:n}},createContinueStatement:function(e){return{type:o.ContinueStatement,label:e}},createDebuggerStatement:function(){return{type:o.DebuggerStatement}},createDoWhileStatement:function(e,t){return{type:o.DoWhileStatement,body:e,test:t}},createEmptyStatement:function(){return{type:o.EmptyStatement}},createExpressionStatement:function(e){return{type:o.ExpressionStatement,expression:e}},createForStatement:function(e,t,n,r){return{type:o.ForStatement,init:e,test:t,update:n,body:r}},createForInStatement:function(e,t,n){return{type:o.ForInStatement,left:e,right:t,body:n,each:!1}},createFunctionDeclaration:function(e,t,n,r){return{type:o.FunctionDeclaration,id:e,params:t,defaults:n,body:r,rest:null,generator:!1,expression:!1}},createFunctionExpression:function(e,t,n,r){return{type:o.FunctionExpression,id:e,params:t,defaults:n,body:r,rest:null,generator:!1,expression:!1}},createIdentifier:function(e){return{type:o.Identifier,name:e}},createIfStatement:function(e,t,n){return{type:o.IfStatement,test:e,consequent:t,alternate:n}},createLabeledStatement:function(e,t){return{type:o.LabeledStatement,label:e,body:t}},createLiteral:function(e){return{type:o.Literal,value:e.value,raw:c.slice(e.start,e.end)}},createMemberExpression:function(e,t,n){return{type:o.MemberExpression,computed:"["===e,object:t,property:n}},createNewExpression:function(e,t){return{type:o.NewExpression,callee:e,arguments:t}},createObjectExpression:function(e){return{type:o.ObjectExpression,properties:e}},createPostfixExpression:function(e,t){return{type:o.UpdateExpression,operator:e,argument:t,prefix:!1}},createProgram:function(e){return{type:o.Program,body:e}},createProperty:function(e,t,n){return{type:o.Property,key:t,value:n,kind:e}},createReturnStatement:function(e){return{type:o.ReturnStatement,argument:e}},createSequenceExpression:function(e){return{type:o.SequenceExpression,expressions:e}},createSwitchCase:function(e,t){return{type:o.SwitchCase,test:e,consequent:t}},createSwitchStatement:function(e,t){return{type:o.SwitchStatement,discriminant:e,cases:t}},createThisExpression:function(){return{type:o.ThisExpression}},createThrowStatement:function(e){return{type:o.ThrowStatement,argument:e}},createTryStatement:function(e,t,n,r){return{type:o.TryStatement,block:e,guardedHandlers:t,handlers:n,finalizer:r}},createUnaryExpression:function(e,t){return"++"===e||"--"===e?{type:o.UpdateExpression,operator:e,argument:t,prefix:!0}:{type:o.UnaryExpression,operator:e,argument:t,prefix:!0}},createVariableDeclaration:function(e,t){return{type:o.VariableDeclaration,declarations:e,kind:t}},createVariableDeclarator:function(e,t){return{type:o.VariableDeclarator,id:e,init:t}},createWhileStatement:function(e,t){return{type:o.WhileStatement,test:e,body:t}},createWithStatement:function(e,t){return{type:o.WithStatement,object:e,body:t}}},e.version="1.2.5",e.tokenize=function(e,n){var r;"string"==typeof e||e instanceof String||(e=String(e)),m=u,f=0,p=(c=e).length>0?1:0,h=0,d=c.length,g=null,y={allowIn:!0,labelSet:{},inFunctionBody:!1,inIteration:!1,inSwitch:!1,lastCommentStart:-1},b={},(n=n||{}).tokens=!0,b.tokens=[],b.tokenize=!0,b.openParenToken=-1,b.openCurlyToken=-1,b.range="boolean"==typeof n.range&&n.range,b.loc="boolean"==typeof n.loc&&n.loc,"boolean"==typeof n.comment&&n.comment&&(b.comments=[]),"boolean"==typeof n.tolerant&&n.tolerant&&(b.errors=[]);try{if(V(),g.type===t.EOF)return b.tokens;for(U();g.type!==t.EOF;)try{U()}catch(e){if(g,b.errors){b.errors.push(e);break}throw e}Ee(),r=b.tokens,void 0!==b.comments&&(r.comments=b.comments),void 0!==b.errors&&(r.errors=b.errors)}catch(e){throw e}finally{b={}}return r},e.parse=function(e,t){var n,r;r=String,"string"==typeof e||e instanceof String||(e=r(e)),m=u,f=0,p=(c=e).length>0?1:0,h=0,d=c.length,g=null,y={allowIn:!0,labelSet:{},inFunctionBody:!1,inIteration:!1,inSwitch:!1,lastCommentStart:-1},b={},void 0!==t&&(b.range="boolean"==typeof t.range&&t.range,b.loc="boolean"==typeof t.loc&&t.loc,b.attachComment="boolean"==typeof t.attachComment&&t.attachComment,b.loc&&null!==t.source&&void 0!==t.source&&(b.source=r(t.source)),"boolean"==typeof t.tokens&&t.tokens&&(b.tokens=[]),"boolean"==typeof t.comment&&t.comment&&(b.comments=[]),"boolean"==typeof t.tolerant&&t.tolerant&&(b.errors=[]),b.attachComment&&(b.range=!0,b.comments=[],b.bottomRightStack=[],b.trailingComments=[],b.leadingComments=[]));try{n=Pe(),void 0!==b.comments&&(n.comments=b.comments),void 0!==b.tokens&&(Ee(),n.tokens=b.tokens),void 0!==b.errors&&(n.errors=b.errors)}catch(e){throw e}finally{b={}}return n},e.Syntax=function(){var e,t={};for(e in"function"==typeof Object.create&&(t=Object.create(null)),o)o.hasOwnProperty(e)&&(t[e]=o[e]);return"function"==typeof Object.freeze&&Object.freeze(t),t}()})?r.apply(t,o):r)||(e.exports=i)}()},,,,function(e,t,n){"use strict";n.r(t);var r=n(0),o=n(9),i=n(5);var a=n(2);function s(e,t,n){return 1===e.shape[0]?e:r.tidy(()=>{const o=e.slice([0,0],[1,t]);let i=n%t;i<=3&&(i+=t);const a=e.slice([e.shape[0]-1,e.shape[1]-i],[-1,-1]);let s=[o,a];if(e.shape[0]>2){const n=e.shape[0]-2;s=[o,e.slice([1,3],[n,t]).as3D(1,n*t,-1),a]}return r.concat(s,1)})}class u{constructor(e,t=250){this.checkpointURL=e,this.chunkLength=t}async initialize(){this.dispose();const e=performance.now(),t=await fetch(`${this.checkpointURL}/weights_manifest.json`).then(e=>e.json()).then(e=>r.io.loadWeights(e,this.checkpointURL));this.build(t),Object.keys(t).map(e=>t[e].dispose()),this.initialized=!0,i.logWithDuration("Initialized model",e,"O&F")}dispose(){this.initialized&&(this.onsetsCnn.dispose(),this.onsetsRnn.dispose(),this.activationCnn.dispose(),this.frameRnn.dispose(),this.velocityCnn.dispose(),this.initialized=!1)}isInitialized(){return this.initialized}async transcribeFromMelSpec(e,t=4){this.isInitialized()||this.initialize();const n=performance.now();i.log("Computing onsets, frames, and velocities...","O&F",20);const[o,s,u]=r.tidy(()=>{const n=function(e,t){let n=Math.ceil(e.length/t),o=e.length%t,i=0;if(n>1&&o>0&&o<=3&&(n-=1,i=o,o=0),1===n)return r.tensor2d(e).expandDims(0);const a=t+6,s=r.tensor2d(e.slice(0,a)).expandDims(0),u=r.tensor2d(e.slice(e.length-a)).expandDims(0);if(2===n)return r.concat([s,u],0);let c;c=o?r.tensor2d(e).pad([[0,t-o],[0,0]]).as3D(n,t,-1):r.tensor2d(e.slice(0,e.length-i)).as3D(n,t,-1);const l=r.slice(c,[0,t-3],[n-2,-1]),f=r.slice(c,[2,0],[-1,3]),p=r.concat([l,c.slice(1,n-2),f],1);return r.concat([s,p,u],0)}(e,this.chunkLength);return this.processBatches(n,this.chunkLength,e.length,t)});i.log("Converting to NoteSequence...","O&F",20);const c=async function(e,t,n,o=.5,i=.5){const s=a.a.create(),u=new Uint32Array(88),c=new Uint8Array(88);let l=new Uint8Array(88);function f(e,t){s.notes.push(a.a.Note.create({pitch:e+21,startTime:.032*(u[e]-1),endTime:.032*t,velocity:c[e]})),u[e]=0}function p(e,t,n){u[e]?l[e]||(f(e,t),u[e]=t+1,c[e]=n):(u[e]=t+1,c[e]=n)}const h=r.tidy(()=>{let a=r.greater(t,o),s=r.greater(e,i);return a=a.pad([[0,1],[0,0]]),s=s.pad([[0,1],[0,0]]),n=n.pad([[0,1],[0,0]]),s=r.logicalOr(s,a),[s,a,n]}),[d,m,g]=await Promise.all(h.map(e=>e.data()));h.forEach(e=>e.dispose());const y=e.shape[0];for(let e=0;e<y+1;++e){for(let t=0;t<88;++t){const n=88*e+t;m[n]?p(t,e,g[n]):!d[n]&&u[t]&&f(t,e)}l=m.slice(88*e,88*(e+1))}return s.totalTime=.032*y,s}(o,s,u);return c.then(()=>{o.dispose(),s.dispose(),u.dispose(),i.logWithDuration("Transcribed from mel spec",n,"O&F")}),c}async transcribeFromAudioBuffer(e,t=4){const n=performance.now(),r=async function(e){const t=await Object(o.h)(e);return Object(o.g)(Object(o.e)(t,{sampleRate:16e3,hopLength:512,nMels:229,nFft:2048,fMin:30}))}(e);return r.then(()=>i.logWithDuration("Converted audio to mel spec",n,"O&F",20)),r.then(e=>this.transcribeFromMelSpec(e.map(e=>Array.from(e),t)))}async transcribeFromAudioFile(e){const t=await Object(o.c)(e);return this.transcribeFromAudioBuffer(t)}async transcribeFromAudioURL(e){const t=await Object(o.d)(e);return this.transcribeFromAudioBuffer(t)}processBatches(e,t,n,o){const i=e=>[this.onsetsCnn.predict(e,o),this.activationCnn.predict(e,o),this.velocityCnn.predict(e,o)];let a,u,c;if(1===e.shape[0])[a,u,c]=i(e.expandDims(-1));else{const r=i(e.expandDims(-1)),o=[];for(let e=0;e<3;++e)o.push(s(r[e],t,n));[a,u,c]=o}const l=this.onsetsRnn.predict(a,this.chunkLength);a.dispose();const f=r.concat3d([l,u],-1);u.dispose();const p=this.frameRnn.predict(f,this.chunkLength),h=r.clipByValue(c,0,1).mul(r.scalar(80)).add(r.scalar(10)).toInt();return c.dispose(),[p.squeeze(),l.squeeze(),h.squeeze()]}build(e){r.tidy(()=>{this.onsetsCnn=new c,this.onsetsCnn.setWeights(e,"onsets"),this.onsetsRnn=new l([null,this.onsetsCnn.outputShape[2]]),this.onsetsRnn.setWeights(e,"onsets","onset_probs"),this.activationCnn=new c("sigmoid"),this.activationCnn.setWeights(e,"frame","activation_probs"),this.frameRnn=new l([null,176]),this.frameRnn.setWeights(e,"frame","frame_probs"),this.velocityCnn=new c("linear"),this.velocityCnn.setWeights(e,"velocity","onset_velocities")})}}class c{constructor(e){this.nn=r.sequential();const t={filters:48,kernelSize:[3,3],activation:"linear",useBias:!1,padding:"same",dilationRate:[1,1],inputShape:[null,229,1],trainable:!1},n={scale:!1,trainable:!1};this.nn.add(r.layers.conv2d(t)),this.nn.add(r.layers.batchNormalization(n)),this.nn.add(r.layers.activation({activation:"relu"})),t.inputShape=null,this.nn.add(r.layers.conv2d(t)),this.nn.add(r.layers.batchNormalization(n)),this.nn.add(r.layers.activation({activation:"relu"})),this.nn.add(r.layers.maxPooling2d({poolSize:[1,2],strides:[1,2]})),t.filters=96,this.nn.add(r.layers.conv2d(t)),this.nn.add(r.layers.batchNormalization(n)),this.nn.add(r.layers.activation({activation:"relu"})),this.nn.add(r.layers.maxPooling2d({poolSize:[1,2],strides:[1,2]}));const o=this.nn.outputShape;this.nn.add(r.layers.reshape({targetShape:[o[1],o[2]*o[3]]})),this.nn.add(r.layers.dense({units:768,activation:"relu",trainable:!1})),e&&this.nn.add(r.layers.dense({units:88,activation:e,trainable:!1})),this.outputShape=this.nn.outputShape}dispose(){this.nn.dispose()}predict(e,t){return this.nn.predict(e,{batchSize:t})}setWeights(e,t,n){function r(t){const n=e[t];if(void 0===n)throw Error(`Variable not found: ${t}`);return n}let o=[r(`${t}/conv0/weights`),r(`${t}/conv0/BatchNorm/beta`),r(`${t}/conv0/BatchNorm/moving_mean`),r(`${t}/conv0/BatchNorm/moving_variance`),r(`${t}/conv1/weights`),r(`${t}/conv1/BatchNorm/beta`),r(`${t}/conv1/BatchNorm/moving_mean`),r(`${t}/conv1/BatchNorm/moving_variance`),r(`${t}/conv2/weights`),r(`${t}/conv2/BatchNorm/beta`),r(`${t}/conv2/BatchNorm/moving_mean`),r(`${t}/conv2/BatchNorm/moving_variance`),r(`${t}/fc_end/weights`),r(`${t}/fc_end/biases`)];n&&(o=o.concat([r(`${t}/${n}/weights`),r(`${t}/${n}/biases`)])),this.nn.setWeights(o)}}class l{constructor(e,t=384){this.dense=r.sequential(),this.units=t,this.lstm=function(){const n=r.layers.lstm({inputShape:e,units:t,returnSequences:!0,recurrentActivation:"sigmoid",returnState:!0,kernelInitializer:"zeros",recurrentInitializer:"zeros",biasInitializer:"zeros",trainable:!1}),o=[r.input({shape:e}),r.input({shape:[t]}),r.input({shape:[t]})],i=n.apply(o);return r.model({inputs:o,outputs:i})}(),this.dense.add(r.layers.dense({inputShape:[null,t],units:88,activation:"sigmoid",trainable:!1}))}dispose(){this.lstm.dispose(),this.dense.dispose()}setWeights(e,t,n){function o(t){const n=e[t];if(void 0===n)throw Error(`Variable not found: ${t}`);return n}const i=(e,t=0)=>{const[n,o,i,a]=r.split(e,4,-1);return r.concat([n,i.add(r.scalar(t)),o,a],-1)},a=e=>r.split(i(e),[e.shape[0]-this.units,this.units]),s="cudnn_lstm/rnn/multi_rnn_cell/cell_0/cudnn_compatible_lstm_cell";this.lstm.setWeights(a(o(`${t}/${s}/kernel`)).concat(i(o(`${t}/${s}/bias`),1))),this.dense.setWeights([o(`${t}/${n}/weights`),o(`${t}/${n}/biases`)])}predict(e,t){return r.tidy(()=>this.predictImpl(e,t))}predictImpl(e,t){const n=e.shape[1],o=Math.ceil(n/t);let i=[r.zeros([1,this.units]),r.zeros([1,this.units])];const a=[];for(let n=0;n<o;++n){const r=e.slice([0,n*t],[-1,n<o-1?t:-1]),s=this.lstm.predict([r,i[0],i[1]]);a.push(this.dense.predict(s[0])),i=s.slice(1)}return 1===a.length?a[0]:r.concat3d(a,1)}}n.d(t,"OnsetsAndFrames",(function(){return u}))}])}));